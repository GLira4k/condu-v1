  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <header className="flex justify-between items-end">
        <div>
          <h1 className="text-base font-semibold tracking-tight text-slate-900 dark:text-white">Configurações & White Label</h1>
      ...
      <form onSubmit={handleSave} className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 space-y-6">
          <div className="bg-premium-card-light dark:bg-premium-card-dark border border-slate-200 dark:border-white/[0.06] rounded-lg p-5 space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <input 
                  ...
                  className="w-full bg-slate-100 dark:bg-slate-900/50 border border-slate-200 dark:border-white/[0.06] rounded-md px-3 py-1.5 text-xs font-medium focus:border-slate-400 dark:focus:border-slate-600 outline-none transition-all text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-600"
              ...
              <div className="md:col-span-2 space-y-1.5">
                ...
                <div className="relative">
                  <MapPin className="absolute left-2.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-slate-500 dark:text-slate-600" />
                  <input 
                    type="text" 
                    placeholder="Rua, Número, Bairro, Cidade - UF"
                    className="w-full bg-slate-100 dark:bg-slate-900/50 border border-slate-200 dark:border-white/[0.06] rounded-md pl-8 pr-3 py-1.5 text-xs font-medium focus:border-slate-400 dark:focus:border-slate-600 outline-none transition-all text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-600"
                    onChange={(e) => e.target.value = sanitizeInput(e.target.value)}
                  />
                </div>
              </div>
          ...
          <div className="bg-premium-card-light dark:bg-premium-card-dark border border-slate-200 dark:border-white/[0.06] rounded-lg p-5 space-y-5">
            ...
            <div className="space-y-2">
              {[
                ...
                <div key={i} className="flex items-center justify-between p-3 rounded-md bg-slate-50/50 dark:bg-white/[0.01] border border-slate-100 dark:border-white/[0.04]">
                  <div>
                    <p className="text-xs font-semibold text-slate-700 dark:text-slate-200">{item.label}</p>
                    <p className="text-[10px] text-slate-500 font-medium">{item.desc}</p>
                  </div>
                  <button type="button" className={`w-7 h-4 rounded-full transition-colors relative flex items-center px-0.5 ${item.active ? 'bg-condu-emerald' : 'bg-slate-300 dark:bg-slate-700'}`}>
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="bg-premium-card-light dark:bg-premium-card-dark border border-slate-200 dark:border-white/[0.06] rounded-lg p-5 space-y-5">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="border border-dashed border-slate-200 dark:border-white/10 rounded-md p-4 flex flex-col items-center justify-center gap-2 bg-slate-50/50 dark:bg-white/[0.01] hover:bg-slate-100/50 dark:hover:bg-white/[0.02] hover:border-slate-300 dark:hover:border-white/20 transition-all cursor-pointer group">
                  <Upload className="w-4 h-4 text-slate-500 group-hover:text-slate-700 dark:group-hover:text-slate-300 transition-colors" />
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between bg-slate-100 dark:bg-slate-900/50 border border-slate-200 dark:border-white/[0.06] rounded-md px-3 py-1.5">
                    <span className="text-[11px] font-medium text-slate-600 dark:text-slate-400">Cor Primária</span>
                  ...
                  <div className="flex items-center justify-between bg-slate-100 dark:bg-slate-900/50 border border-slate-200 dark:border-white/[0.06] rounded-md px-3 py-1.5">
                    <span className="text-[11px] font-medium text-slate-600 dark:text-slate-400">Cor Secundária</span>
                    <div className="flex items-center gap-2">
          ...
          <div className="bg-emerald-500/[0.02] border border-emerald-500/10 rounded-lg p-5">
            ...
            <button type="button" className="mt-3 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest hover:text-slate-900 dark:hover:text-white transition-colors flex items-center gap-1">
