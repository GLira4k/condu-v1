  ...
  return (
    <div className="min-h-screen bg-[#07080a] p-4 md:p-8 space-y-8">
      <header className="space-y-1">
        <h1 className="text-xl font-bold tracking-tight text-white">Ocorrências & Solicitações</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <Card className="sticky top-8 border-white/[0.06] bg-[#101114]">
            <CardHeader>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <select className="w-full rounded-md border border-white/[0.06] bg-[#16171d] px-3 py-1.5 text-xs text-white focus:outline-none focus:border-slate-600 transition-colors">
              ...
              <div className="space-y-2">
                ...
                <textarea 
                  className="w-full min-h-[100px] rounded-md border border-white/[0.06] bg-[#16171d] px-3 py-1.5 text-xs text-white placeholder:text-slate-500 focus:outline-none focus:border-slate-600 transition-colors resize-none"
                  placeholder="Detalhe o ocorrido..."
                />
              </div>
              <div className="border-2 border-dashed border-white/[0.04] rounded-md p-4 flex flex-col items-center justify-center gap-2 bg-white/[0.01] cursor-pointer hover:bg-white/[0.02] transition-colors">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="relative">
              ...
              <input 
                type="text" 
                placeholder="Buscar..." 
                className="bg-[#16171d] border border-white/[0.06] rounded-md pl-8 pr-3 py-1 text-[10px] text-white focus:outline-none focus:border-slate-600 w-40"
              />
            </div>
          </div>

          <Card className="border-white/[0.06] bg-[#101114] overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                ...
                <tbody className="divide-y divide-white/[0.02]">
                  {occurrences.map((occ) => (
                    <tr key={occ.id} className="hover:bg-white/[0.01] transition-colors group">
                      <td className="px-4 py-3 text-[11px] font-mono text-slate-400">{occ.id}</td>
                      <td className="px-4 py-3">
                        <div className="space-y-0.5">
                          <p className="text-[11px] text-slate-200">{occ.subject}</p>
                          <p className="text-[9px] text-slate-600 uppercase">{occ.category}</p>
                        </div>
                      </td>
